<template>
  <div id="prefecture">
    <div class="pref-oita">
      <h1>Oita</h1>
      <router-link :to="{name: 'CreateRoom', params: { value: 'Oita' }}" class="pref-create">Create your chatroom in Oita page</router-link>
...
<script>
  ...
  export default {
    ...
    created() {
      this.roomsRef = firebase.firestore().collection("rooms").where("prefecture", "==", "Oita");
