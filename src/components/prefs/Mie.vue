<template>
  <div id="prefecture">
    <div class="pref-mie">
      <h1>Mie</h1>
      <router-link :to="{name: 'CreateRoom', params: { value: 'Mie' }}" class="pref-create">Create your chatroom in Mie page</router-link>
...
<script>
  ...
  export default {
    ...
    created() {
      this.roomsRef = firebase.firestore().collection("rooms").where("prefecture", "==", "Mie");
